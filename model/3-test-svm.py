...
def train_schedule_svm():
  ...
  #clf = SVC(C=10e5, gamma='auto',kernel='rbf',class_weight={0: 8, 1: 2})
  #clf = SVC(C=10e5, gamma='auto',kernel='linear',class_weight={0: 8, 1: 2})
  ...
  save_model(clf, "schedule_svm-model-3.m")
...
def test_schedule(verbose=True):
  ...
  clf = load_model("schedule_svm-model-3.m")
